...
import { UpdateDeliveredController } from './modules/deliveries/useCases/updateDeliveredDate/UpdateDeliveredController';
...
routes.put(
  '/delivery/updateDelivered/:id',
  ensureAuthenticateDeliveryman,
  updateDeliveredController.handle,
);
